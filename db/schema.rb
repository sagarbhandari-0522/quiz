...
ActiveRecord::Schema[7.0].define(version: 20_220_427_103_554) do
  ...
  create_table 'categories_quizzes', id: false, force: :cascade do |t|
    ...
    t.index %w[category_id quiz_id], name: 'index_categories_quizzes_on_category_id_and_quiz_id'
    t.index %w[quiz_id category_id], name: 'index_categories_quizzes_on_quiz_id_and_category_id'
  end
